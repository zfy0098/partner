 ...
 *  @author hadoop
 */
public class OnlinePartnerProfitOptimize extends BaseDao {


	public void init() throws Exception{

		System.out.println("进入init 方法 , 开始执行睡眠");
		Thread.sleep(10000);

		System.out.println("睡眠完成 ， 方法执行结束");
...
//		EmailUtil.sendMail("合伙人分润", "合伙人分润", new String[]{zipFileName});
	...
	public static void  main(String[] args)throws Exception {
		OnlinePartnerProfitOptimize onlinePartnerProfit = new OnlinePartnerProfitOptimize();
		onlinePartnerProfit.init("2018-02-10");
	}
